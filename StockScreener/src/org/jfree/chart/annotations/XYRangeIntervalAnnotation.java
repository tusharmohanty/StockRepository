 ...
 * @author peter
 */
public class XYRangeIntervalAnnotation extends IntervalAnnotation implements XYAnnotation{
    
    public XYRangeIntervalAnnotation(double startValue, double endValue){
